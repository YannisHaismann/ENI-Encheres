		...
		<form action="<%=request.getContextPath()%>/ServletNouvelleVente"
			...
			<p>
				<label for="photo">Photo de l'article: </label><input
					style="text-align: left;" id="photoUpload" type="file" id="photo"
					name="photo" value="UPLOADER">
			</p>
			...
			<p style="text-align: center;">
				<label>Retrait: </label><span>ADRESSE DE RETRAIT</span>
			</p>
			<input class="enregistrer-button" type="submit" value="ENREGISTRER"
				name="enregistrer"> <input class="annuler-button"
				type="submit" value="ANNULER" name="annuler">
		</form>
