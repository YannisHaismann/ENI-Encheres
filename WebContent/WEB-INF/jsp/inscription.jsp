...
<body style="background-image: url('./images/fond_page_connexion.jpg');">
	...
	<div class="inscription-box">
		...
		<form action="<%=request.getContextPath()%>/ServletAjouterUtilisateur"
			...
			<div>
				<label class="label-droit" for="confirmation">Confirmation
				...
				<input class="creer-button" name="creer-button" type="submit"
					value="Créer">
			
			
				<input class="annuler-button" name="annuler-button" type="submit"
					value="Annuler">
