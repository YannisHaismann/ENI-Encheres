	...
	<div>
		<div>
			<a href="<%=request.getContextPath()%>/ChoixSupprimer"><input
				type="button" value="Supprimer un profil" /></a>
		</div>
		<div>
			<a href="<%=request.getContextPath()%>/ChoixDesactiver"><input
				type="button" value="Activer/Desactiver profil" /></a>
		</div>
		<div>
			<a href="<%=request.getContextPath()%>/ChoixAdmin"><input
				type="button" value="Activer/Desactiver les droits d'administrations" /></a>
		</div>
		<div>
